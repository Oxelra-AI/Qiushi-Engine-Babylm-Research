#!/usr/bin/env python3
"""Launch one research/research MLM training control with the common 8x480 baseline16k WWM recipe.

This wrapper exists to reduce duplicated bash launchers for controls.  It still runs
masking_curriculum_trainer.py as a subprocess and records the exact command.
"""
...
def main():
    ...
    env["TMPDIR"] = f"/tmp/q_step029_{args.label[:20]}"
