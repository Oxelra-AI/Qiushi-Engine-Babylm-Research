...
_THIS_FILE = _public_path('experiments/archive/functional_learning/data/v5_candidate_export/Qiushi-Engine-Principle-Guided-Frontier-Advancement/modeling_frozen_slow_private_debertav2.py')
...
class FrozenSlowPrivateDebertaV2ForMaskedLM(DebertaV2ForMaskedLM):
    ...
    def __init__(self, config: DebertaV2Config):
        ...
        config.auto_map = {
            "AutoModelForMaskedLM": "modeling_frozen_slow_private_debertav2.FrozenSlowPrivateDebertaV2ForMaskedLM",
            "AutoModel": "modeling_frozen_slow_private_debertav2.FrozenSlowPrivateDebertaV2Model"
        }
    ...
    def save_pretrained(self, save_directory, *args, **kwargs):
        # Enforce neutral auto_map before serialization
        _MODULE = "modeling_frozen_slow_private_debertav2"
        self.config.architectures = [self.__class__.__name__]
        self.config.auto_map = {
            "AutoModelForMaskedLM": f"{_MODULE}.FrozenSlowPrivateDebertaV2ForMaskedLM",
            "AutoModel": f"{_MODULE}.FrozenSlowPrivateDebertaV2Model",
        }
        super().save_pretrained(save_directory, *args, **kwargs)
        dst = Path(save_directory) / f"{_MODULE}.py"
