#!/usr/bin/env python3
"""research wrapper: research temperature/source readout with clean preservation endpoints.

This preserves the research scoring implementation and only extends MODEL_SPECS with
research clean ordinary-full-row parent-distillation endpoints. It is a frozen-
checkpoint mechanism readout, not official BabyLM scoring.
"""
