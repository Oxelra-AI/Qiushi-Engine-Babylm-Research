#!/usr/bin/env python3
"""research wrapper: research temperature/source readout including ordinary control.

Adds the verified research ordinary `inherited_wwm` endpoint to the aligned
source-response readout so the attribution graph can compare ordinary WWM,
exact dense-mask/sparse-label acquisition, and clean parent-anchored endpoints
on the same Qwen/source tasks.  This is a mechanism readout, not BabyLM
leaderboard scoring.
"""
