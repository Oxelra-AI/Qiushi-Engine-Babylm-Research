...
FILES = {
    'consistency_10M': ROOT/'data/seed2_entity_consistency_consistency_10M_available_coordinate.json',
    'consistency_20M': ROOT/'data/seed2_entity_consistency_consistency_20M_available_coordinate.json',
    'shuffled_10M': ROOT/'data/seed2_entity_consistency_shuffled_10M_available_coordinate.json',
    'shuffled_20M': ROOT/'data/seed2_entity_consistency_shuffled_20M_available_coordinate.json',
}
TRAIN_VAL = ROOT/'data/seed2_entity_consistency_20m_training_validation.json'
OUT = ROOT/'data/seed2_entity_consistency_available_coordinate_comparison.json'
NOTE = (ROOT.parents[2] / 'research/notes/initial_model_studies/seed2_entity_consistency_available_coordinate_comparison.md')
COLS = [
...
def main():
    ...
    lines = ['# research — seed2 Entity Mention Consistency available-coordinate comparison', '', f'Evidence JSON: `{OUT}`', '', 'Higher is better for all columns including Reading.', '']
