...
SUMMARY = ROOT / 'data/lamb_s1_10m_ewok_word_tokenize_filter_summary.json'
SCORE_JSON = ROOT / 'data/lamb_s1_10m_full_ewok_word_tokenize_score.json'
NOTE = (ROOT.parents[2] / 'research/notes/initial_model_studies/lamb_s1_10m_full_ewok_word_tokenize_score.md')
LOG = (ROOT.parents[2] / 'research/notes/initial_model_studies/lamb_s1_10m_full_ewok_eval.log')
