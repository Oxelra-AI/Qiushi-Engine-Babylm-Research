...
OUTDIR=(ROOT/'data/leader_package_revision_124/model_side/eval_results_available_direct').resolve()
OUT_JSON=ROOT/'data/public_leader_available_coordinate.json'
OUT_NOTE=(ROOT.parents[2] / 'research/notes/initial_model_studies/public_leader_available_coordinate.md')
LOG=(ROOT.parents[2] / 'research/notes/initial_model_studies/public_leader_eval.log')
BACKEND='mlm'; REV='public_leader_local'
TASKS=[
