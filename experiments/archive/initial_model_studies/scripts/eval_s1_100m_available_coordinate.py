...
RUN=ROOT/'training/runs/babylm_leadershape_s1_100M_aligned_micro128'
MODEL=(RUN/'hf_model/chck_100M').resolve()
OUTDIR=(RUN/'eval_results_chck100M_available_direct').resolve()
OUT_JSON=ROOT/'data/s1_100m_available_coordinate.json'
OUT_NOTE=(ROOT.parents[2] / 'research/notes/initial_model_studies/s1_100m_available_coordinate.md')
LOG=(ROOT.parents[2] / 'research/notes/initial_model_studies/s1_100m_eval.log')
