...
_THIS_FILE = _public_path('experiments/archive/relation_learning/data/binding_factorial/answer_corrupt_update_state/checkpoint/adapter_scaled_modeling.py')
