...
_THIS_FILE = _public_path('experiments/archive/relation_learning/data/binding_factorial_balanced_pairbatch_smoke/answer_clean/checkpoint/adapter_scaled_modeling.py')
