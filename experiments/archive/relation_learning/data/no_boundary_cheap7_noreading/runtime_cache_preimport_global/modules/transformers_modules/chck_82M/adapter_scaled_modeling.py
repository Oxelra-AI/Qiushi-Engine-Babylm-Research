...
_THIS_FILE = _public_path('experiments/archive/relation_learning/data/no_boundary_cheap7_noreading/runtime_cache_preimport_global/modules/transformers_modules/chck_82M/adapter_scaled_modeling.py')
