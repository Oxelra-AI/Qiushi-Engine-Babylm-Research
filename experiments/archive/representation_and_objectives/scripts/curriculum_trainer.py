...
def pre_tokenize_all(examples: list, tokenizer, max_seq_len: int) -> list[PreTokenizedRow]:
...
def build_args() -> argparse.Namespace:
    ...
    p.add_argument("--min_chunk_tokens", type=int, default=8)
...
def main() -> None:
    ...
    t0 = time.time()
    pre_tok_rows = pre_tokenize_all(examples, tokenizer, args.max_seq_length)
    print(json.dumps({
