#!/usr/bin/env python3
"""EWoK four-cell wrapper for Muon/AdamW 40M artifacts.

Reuses the research EWoK four-cell reader without copying the scoring code.  The
four target checkpoints all exist at the same 40M exposure.  Outputs are written
under representation_and_objectives only.
"""
...
OUT_ROOT = A01_WS / "data/muon_switch_40m_ewok_interaction"
NOTE = A01_WS / "notes/126_muon_switch_40m_ewok_interaction.md"

TARGETS: dict[str, dict[str, Any]] = {
    "adamw40": {
        "model_path": A02_WS / "training/runs/complianttok_reinvest_seed43022_r2/hf_model/chck_40M",
        "label": "continuous AdamW legal compact reinvest 40M reference",
    },
    "continuous_muon40": {
        "model_path": A02_WS / "training/runs/muon_lr008_wd00125_seed43022_80M/hf_model/chck_40M",
        "label": "continuous matched-decay Muon 40M reference",
    },
    "muon20toadamw40": {
        "model_path": A02_WS / "training/runs/muon20toadamw_seed43022_80M/hf_model/chck_40M",
        "label": "Muon for 20M then AdamW consolidation to 40M",
    },
    "muon40toadamw40": {
        "model_path": A02_WS / "training/runs/muon40toadamw_seed43022_80M/hf_model/chck_40M",
        "label": "Muon for 40M at switch boundary",
    },
}


def load_base_module():
    spec = importlib.util.spec_from_file_location("ewok_for_muon_switch40", BASE_SCRIPT)
