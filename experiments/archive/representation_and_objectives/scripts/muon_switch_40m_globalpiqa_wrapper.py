#!/usr/bin/env python3
"""GlobalPIQA hard-rank wrapper for Muon/AdamW 40M artifacts.

Reuses the validated research all-option GlobalPIQA reader, adding the four 40M
optimizer-comparison checkpoints as targets.  Outputs are written only under representation_and_objectives.
"""
...
OUT_ROOT = A01_WS / "data/muon_switch_40m_globalpiqa_margin"
NOTE = A01_WS / "notes/muon_switch_40m_globalpiqa_margin.md"

TARGETS: dict[str, dict[str, Any]] = {
    "adamw40": {
        "label": "continuous AdamW legal compact reinvest 40M reference",
        "model_root": A02_WS / "training/runs/complianttok_reinvest_seed43022_r2/hf_model/chck_40M",
        "revision": "main",
    ...
    "continuous_muon40": {
        ...
        "model_root": A02_WS / "training/runs/muon_lr008_wd00125_seed43022_80M/hf_model/chck_40M",
        "revision": "main",
        "official_parallel": None,
        "official_nonparallel": None,
    },
    "muon20toadamw40": {
        ...
        "model_root": A02_WS / "training/runs/muon20toadamw_seed43022_80M/hf_model/chck_40M",
        "revision": "main",
        "official_parallel": None,
        "official_nonparallel": None,
    },
    "muon40toadamw40": {
        ...
        "model_root": A02_WS / "training/runs/muon40toadamw_seed43022_80M/hf_model/chck_40M",
        "revision": "main",
        "official_parallel": None,
        "official_nonparallel": None,
    },
...
def load_base_module():
    spec = importlib.util.spec_from_file_location("globalpiqa_for_muon_switch40", BASE_SCRIPT)
