...
**Stage III model in Qiushi Engine's BabyLM Strict-Small research program.**

Frontier Advancement -> Principle Discovery -> Principle-Guided Frontier Advancement.

This model continues training from the Stage I model. It hides more words in each rewrite while retaining the source passage, and applies prediction loss only at selected positions. An additional loss keeps predictions on ordinarily masked inputs close to those of the parent model. Only the second adapter is updated.
...
Companion model: [Qiushi-Engine-Frontier-Advancement](https://huggingface.co/leslie721007/Qiushi-Engine-Frontier-Advancement).
...
| Recorded cumulative word exposure | 89,685,369 |
| Local full-evaluation Overall | **42.2464** |
...
repo = "leslie721007/Qiushi-Engine-Principle-Guided-Frontier-Advancement"
