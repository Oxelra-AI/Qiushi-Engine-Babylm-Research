...
Summary JSON: `experiments/archive/frontier_consolidation/data/broad_noaoa_avg43122/broad_noaoa_late_checkpoints_summary.json`

## Scores
| target | BLiMP | Supp | EWoK-fast | Entity fast | Entity full | COMPS | GPIQA | Reading | equal7 fast | equal7 fullEnt |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| avg43122_80_100 | 65.340 | 64.800 | 50.270 | 26.690 | 26.190 | 51.600 | 36.090 | 8.915 | 43.386 | 43.315 |
...
## Contrasts
- **avg43122_80_100_minus_r43122_100M_fast**: equal7_full_entity +0.438, equal7_mean +0.454, BLiMP -0.410, Supplement +1.600, EWoK +0.910, Entity_full -0.100, COMPS +0.060, GlobalPIQA_mean +0.955, Reading +0.050
