# shuffle control audit conclusion dual-view training audit — aligned_shuffled_mlm_only_completed
...
## mlm_only
Run: `experiments/archive/frontier_consolidation/training/runs/dualview_mlm_only_20M_seed43022`
metrics exists: `True`; log lines: `506`; chck_20M: `True`; final: `True`
charged/main/aux words: `20000000` / `20000000` / `0`; updates `506`; final loss `3.870621681213379`
...
## aligned_vs_mlm_only_config
```json
{
  "config_equality_common_scaffold": {
    "seed": {
      "a": 43,
      "b": 43,
      "equal": true
...
JSON: `experiments/archive/frontier_consolidation/data/dualview_training_audit/aligned_shuffled_mlm_only_completed.json`
