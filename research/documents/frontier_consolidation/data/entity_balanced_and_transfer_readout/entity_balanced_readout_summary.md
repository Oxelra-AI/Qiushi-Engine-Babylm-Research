...
| deberta_breadth_minus_repeat | official_all18_delta_pp | 2 | +0.990 | +0.580 | +1.400 |
| deberta_breadth_minus_repeat | zero_ops_delta_pp | 2 | -12.920 | -13.663 | -12.177 |
| deberta_breadth_minus_repeat | nonzero_ops_delta_pp | 2 | +3.772 | +3.429 | +4.115 |
| deberta_breadth_minus_repeat | balanced_zero_nonzero_delta_pp | 2 | -4.574 | -5.117 | -4.031 |
| deberta_breadth_minus_repeat | nonzero_minus_zero_spread_pp | 2 | +16.692 | +16.292 | +17.092 |
| deberta_view_minus_breadth | official_all18_delta_pp | 2 | +3.091 | +3.081 | +3.101 |
| deberta_view_minus_breadth | zero_ops_delta_pp | 2 | +3.213 | +3.177 | +3.249 |
| deberta_view_minus_breadth | nonzero_ops_delta_pp | 2 | +3.067 | +3.047 | +3.086 |
| deberta_view_minus_breadth | balanced_zero_nonzero_delta_pp | 2 | +3.140 | +3.132 | +3.148 |
| deberta_view_minus_breadth | nonzero_minus_zero_spread_pp | 2 | -0.147 | -0.202 | -0.091 |
...
- subtask_scores_csv: `experiments/archive/frontier_consolidation/data/entity_balanced_and_transfer_readout/entity_subtask_scores.csv`
- aggregate_scores_csv: `experiments/archive/frontier_consolidation/data/entity_balanced_and_transfer_readout/entity_aggregate_scores.csv`
- contrast_rows_csv: `experiments/archive/frontier_consolidation/data/entity_balanced_and_transfer_readout/entity_contrast_rows.csv`
- balanced_rows_csv: `experiments/archive/frontier_consolidation/data/entity_balanced_and_transfer_readout/entity_balanced_rows.csv`
- late_summary_csv: `experiments/archive/frontier_consolidation/data/entity_balanced_and_transfer_readout/entity_late_summary_rows.csv`
- summary_json: `experiments/archive/frontier_consolidation/data/entity_balanced_and_transfer_readout/entity_balanced_readout_summary.json`
- summary_md: `research/documents/frontier_consolidation/data/entity_balanced_and_transfer_readout/entity_balanced_readout_summary.md`
