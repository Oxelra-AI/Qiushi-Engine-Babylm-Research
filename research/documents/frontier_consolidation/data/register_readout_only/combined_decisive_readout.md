...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| childspeech_minus_adultprose | chck_80M | -1.1300 | -0.0200 | -0.0500 | -0.7700 | -0.5900 | -0.4925 | -0.5120 | 5 |
| regmax_childspeech_minus_clean | chck_80M | -0.4700 | +1.1600 | +0.3200 | +0.0900 | +1.4700 | +0.2750 | +0.5140 | 5 |
| regmax_adultprose_minus_clean | chck_80M | +0.6600 | +1.1800 | +0.3700 | +0.8600 | +2.0600 | +0.7675 | +1.0260 | 5 |
| childspeech_minus_adultprose | chck_100M | -1.4500 | -1.5600 | +0.9400 | -0.3800 | -1.1200 | -0.6125 | -0.7140 | 5 |
| regmax_childspeech_minus_clean | chck_100M | -0.9300 | +0.3400 | +0.7000 | +0.2200 | +1.0200 | +0.0825 | +0.2700 | 5 |
...
- summary_json: `experiments/archive/frontier_consolidation/data/register_readout_only/combined_decisive_readout.json`
- summary_md: `research/documents/frontier_consolidation/data/register_readout_only/combined_decisive_readout.md`
- arm_csv: `experiments/archive/frontier_consolidation/data/register_readout_only/arm_scores_vs_clean.csv`
- contrast_csv: `experiments/archive/frontier_consolidation/data/register_readout_only/decisive_contrasts.csv`
