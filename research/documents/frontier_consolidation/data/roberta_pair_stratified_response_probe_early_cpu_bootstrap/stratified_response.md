...
## chck_10M
- Overall local advantage: `0.01891807124271029` over `5224` events / `7499` pieces, cluster bootstrap p05/p50/p95 `0.01152838529999723/0.01872432618946224/0.025030496483319314`, p>0 `1.0`
- View/category advantages:
  - `compact|function_other`: advantage `-0.0617604996171419`, events `1076`, bootstrap p05/p50/p95 `-0.07631338795625539/-0.06169608235359192/-0.04928287395076271`, p>0 `0.0`
  - `compact|retained_content`: advantage `0.05827357642762287`, events `1071`, bootstrap p05/p50/p95 `0.044331663300514725/0.057848764418590895/0.07238004632540675`, p>0 `1.0`
  - `compact|source_absent_content`: advantage `0.07915629188486394`, events `934`, bootstrap p05/p50/p95 `0.06621428944554109/0.07984736447777253/0.09284163607988537`, p>0 `1.0`
  - `repeat|function_other`: advantage `-0.11532579612731933`, events `1069`, bootstrap p05/p50/p95 `-0.12722306926013532/-0.11640632502237956/-0.10063513238113243`, p>0 `0.0`
  - `repeat|retained_content`: advantage `0.06179415247181392`, events `1074`, bootstrap p05/p50/p95 `0.049423224466828265/0.0617011983850881/0.07380569712171015`, p>0 `1.0`
...
## chck_20M
- Overall local advantage: `0.04398561093088372` over `5224` events / `7499` pieces, cluster bootstrap p05/p50/p95 `0.03547657666288902/0.04367985188121527/0.051161761641171546`, p>0 `1.0`
- View/category advantages:
  - `compact|function_other`: advantage `0.01927199743342629`, events `1076`, bootstrap p05/p50/p95 `0.003485435346849557/0.019601127531676164/0.035744944478165966`, p>0 `0.9833333333333333`
  - `compact|retained_content`: advantage `0.049169936150980094`, events `1071`, bootstrap p05/p50/p95 `0.030918060825560905/0.048667924369921525/0.06586383290733158`, p>0 `1.0`
  - `compact|source_absent_content`: advantage `0.12738112411243002`, events `934`, bootstrap p05/p50/p95 `0.1067773638698177/0.1285067950754943/0.14890880044301352`, p>0 `1.0`
  - `repeat|function_other`: advantage `0.003069598303900825`, events `1069`, bootstrap p05/p50/p95 `-0.014260445767635693/0.002684742742585966/0.01820580426434375`, p>0 `0.6066666666666667`
  - `repeat|retained_content`: advantage `0.01012902402045959`, events `1074`, bootstrap p05/p50/p95 `-0.010617422645343327/0.010874717321422292/0.028918463589776865`, p>0 `0.8166666666666667`
- Feature contrast highlights (positive = stronger compact local advantage in the higher-feature stratum):
