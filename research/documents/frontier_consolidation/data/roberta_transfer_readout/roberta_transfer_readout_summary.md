...
- contrast_rows_csv: `experiments/archive/frontier_consolidation/data/roberta_transfer_readout/roberta_transfer_contrast_rows.csv`
- summary_rows_csv: `experiments/archive/frontier_consolidation/data/roberta_transfer_readout/roberta_transfer_summary_rows.csv`
- summary_json: `experiments/archive/frontier_consolidation/data/roberta_transfer_readout/roberta_transfer_readout_summary.json`
- summary_md: `research/documents/frontier_consolidation/data/roberta_transfer_readout/roberta_transfer_readout_summary.md`
