...
- selected pairs: `3625` from `900` packed changed rows; train/test split by row = `630`/`270` rows.
...
- content_overlap mean: `0.5955`; content_recall mean: `0.6636`.
...
|---|---:|---:|---:|---:|
| identity frozen reps | 1.0000 | 0.6238 | 0.9836 | 0.9973 |
| detached private projection | 0.9991 | 0.6407 | 0.9872 | 0.9963 |

## Private-channel readout
- same-row margin improvement over identity: `0.016963235005062804`.
- same-row top1 improvement over identity: `-0.0009132420091324533`.
...
JSON: `experiments/archive/frontier_consolidation/data/separate_pair_private_channel_probe/separate_pair_private_channel_probe.json`
