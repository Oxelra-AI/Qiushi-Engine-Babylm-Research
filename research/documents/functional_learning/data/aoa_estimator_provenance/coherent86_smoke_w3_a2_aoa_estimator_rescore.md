# earlier analysis AoA estimator rescore: coherent86_smoke_w3_a2
...
| `sensitivity_no_context_mean` | `False` | 0 | 0 | 0 | None | None |
| `sensitivity_unscaled_random_ceiling` | `False` | 0 | 0 | 1 | None | None |
| `sensitivity_unbounded_fit` | `False` | 0 | 0 | 0 | None | None |
| `sensitivity_combined_legacy_like` | `False` | 0 | 0 | 0 | None | None |
...
Full JSON: `experiments/archive/functional_learning/data/aoa_estimator_provenance/coherent86_smoke_w3_a2_aoa_estimator_rescore.json`
