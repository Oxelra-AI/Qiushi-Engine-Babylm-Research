...
- `rollback_alpha_0_vs_parent`: qwen max |ΔNLL_T1| `0.0`, common max |ΔNLL_T1| `12.408926367759705`, pass `False`.
- `rollback_alpha_1_vs_densemask`: qwen max |ΔNLL_T1| `5.7220458984375e-06`, common max |ΔNLL_T1| `12.831382095813751`, pass `False`.
