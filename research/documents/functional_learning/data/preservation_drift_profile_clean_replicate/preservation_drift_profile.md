...
- dense_focus_seed62064: KL(t||s) `0.02827255`, ΔCE(s-t) `0.031519`, Δrank(s-t) `6.282`, CE-improved `0.459`, rank-improved `0.096`
- pres_lambda1_trainmode_confounded: KL(t||s) `0.01381096`, ΔCE(s-t) `0.022016`, Δrank(s-t) `4.651`, CE-improved `0.533`, rank-improved `0.087`
...
- lambda1_minus_densemask: {"kl_teacher_to_student_mean_delta": -0.01067543715227051, "delta_ce_student_minus_teacher_delta": -0.006952814029181929, "delta_rank_student_minus_teacher_delta": -1.2310591418631622}
