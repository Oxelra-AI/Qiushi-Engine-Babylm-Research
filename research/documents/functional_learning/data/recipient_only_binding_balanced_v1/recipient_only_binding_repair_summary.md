...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| standard_wwm15 | train | +0.126 | -0.153 | +0.242 | -0.395 | -0.027 | 16/36 | 19/36 | 21/36 | 0/36 | 1707 | 140 | 59444 |
| standard_wwm15 | heldout | +0.125 | -0.086 | +0.266 | -0.351 | +0.039 | 5/12 | 7/12 | 7/12 | 0/12 | 1707 | 140 | 59444 |
| focused_answer_plus_same_bg | train | +0.180 | -0.200 | +0.305 | -0.505 | -0.020 | 16/36 | 19/36 | 21/36 | 0/36 | 11520 | 0 | 59750 |
| focused_answer_plus_same_bg | heldout | +0.189 | -0.132 | +0.249 | -0.381 | +0.056 | 5/12 | 7/12 | 7/12 | 0/12 | 11520 | 0 | 59750 |

## Interpretation

This repaired run should be read as a recipient-sensitive control, not as proof of a general principle by itself. The same new-state word is used in the target-update and distractor-update contexts, so a successful recipient flip must follow the updated entity rather than the state word alone. Absolute UPDATE, RETAIN, and NEUTRAL margins are reported because a change in R-N alone can be caused by a movement of either term. On held-out repaired groups, coherent86 baseline recipient-flip correctness is 0/12 with U=+0.06, R=-0.01, N=+0.33. After the fixed-budget standard arm it is 0/12 with U=+0.12, R=-0.09, N=+0.27; after focused answer-plus-same-background it is 0/12 with U=+0.19, R=-0.13, N=+0.25. The focused arm does not clearly outperform standard on the repaired held-out contrast, so the credit allocation binding pilot stronger conclusion should be withdrawn; the experience design or scoring frame still permits shortcuts or the intervention fails to install recipient-sensitive selection.

## Files

- summary_json: `experiments/archive/functional_learning/data/recipient_only_binding_balanced_v1/recipient_only_binding_repair_summary.json`
- summary_md: `research/documents/functional_learning/data/recipient_only_binding_balanced_v1/recipient_only_binding_repair_summary.md`
- train_groups: `experiments/archive/functional_learning/data/recipient_only_binding_balanced_v1/train_groups.jsonl`
- heldout_groups: `experiments/archive/functional_learning/data/recipient_only_binding_balanced_v1/heldout_groups.jsonl`
- train_packets: `experiments/archive/functional_learning/data/recipient_only_binding_balanced_v1/train_packets.jsonl`
- heldout_packets: `experiments/archive/functional_learning/data/recipient_only_binding_balanced_v1/heldout_packets.jsonl`
- tokenization_validation: `experiments/archive/functional_learning/data/recipient_only_binding_balanced_v1/tokenization_validation.json`
