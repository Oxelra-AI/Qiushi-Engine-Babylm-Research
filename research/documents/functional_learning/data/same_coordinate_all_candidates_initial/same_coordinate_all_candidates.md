...
- blocking errors: `missing_task:Entity`, `missing_task:COMPS`, `missing_task:GlobalPIQA_parallel`, `missing_task:GlobalPIQA_nonparallel`, `missing_task:Reading`, `payload_not_loaded`, `missing_component:BLiMP`, `missing_component:Supplement`, `missing_component:EWoK`, `missing_component:Entity`, `missing_component:COMPS`, `missing_component:SuperGLUE`, `missing_component:GlobalPIQA`, `missing_component:Reading`
...
- delta vs coherent86: `None`
- components: `{"BLiMP": null, "Supplement": null, "EWoK": null, "Entity": null, "COMPS": null, "SuperGLUE": null, "GlobalPIQA": null, "Reading": null, "AoA": 0.0}`
- blocking errors: `payload_not_loaded`, `missing_superglue_task`, `missing_component:BLiMP`, `missing_component:Supplement`, `missing_component:EWoK`, `missing_component:Entity`, `missing_component:COMPS`, `missing_component:SuperGLUE`, `missing_component:GlobalPIQA`, `missing_component:Reading`
