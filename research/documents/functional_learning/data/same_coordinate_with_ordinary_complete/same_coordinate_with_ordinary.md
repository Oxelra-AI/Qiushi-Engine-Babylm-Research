...
- complete same-coordinate: `True`
- Overall: `42.09260586321611`
- delta vs coherent86: `0.06863787190100368`
- present components: `{'present_components': ['BLiMP', 'Supplement', 'EWoK', 'Entity', 'COMPS', 'SuperGLUE', 'GlobalPIQA', 'Reading', 'AoA'], 'missing_components': [], 'sum_present': 378.833452768945, 'n_present': 9}`
- components: `{"BLiMP": 68.47, "Supplement": 63.63, "EWoK": 49.83, "Entity": 28.16, "COMPS": 52.0, "SuperGLUE": 68.98845276894495, "GlobalPIQA": 39.535, "Reading": 8.22, "AoA": 0.0}`
...

{
  "ordinary_seed62064_vs_coherent86": {
    "available": true,
    "overall_delta_ordinary_minus_coherent86": 0.06863787190100368,
    "component_deltas_ordinary_minus_coherent86": {
      ...
      "SuperGLUE": 0.042740847109016045,
  ...
  "ordinary_seed62064_vs_exact_ms_seed62064": {
    "available": true,
    "overall_delta_ordinary_minus_ms": -0.10993209112042024,
...

{
  ...
  "ordinary_inherited_wwm_seed62064": {
    "complete": true,
    "official_delta_vs_coherent86": 0.06863787190100368,
    "delta_vs_coherent86_with_GlobalPIQA_difference_zeroed": -0.03913990587677654
  }
}
