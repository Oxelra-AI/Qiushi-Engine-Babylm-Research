...
Complete for Overall: `True`; Overall: `42.1159198215161`; missing: `[]`; conflicts: `[]`

| component | admitted score | chosen source | chosen path | notes |
|---|---:|---|---|---|
| BLiMP | 68.520000000000 | A02_custom_single_component | `experiments/archive/relation_learning/data/o62065_BLiMP/o62065/with_special/BLiMP_component_payload.json` | no_predictions_for_item_analysis;score_coverage_uses_record_count |
...
| COMPS | 52.000000000000 | A02_custom_single_component | `experiments/archive/relation_learning/data/o62065_COMPS/o62065/with_special/COMPS_component_payload.json` | no_predictions_for_item_analysis;score_coverage_uses_record_count |
...
| SuperGLUE mean | 69.273278393645 | derived | - | primary metrics: {"boolq": 67.4006116207951, "multirc": 68.44059405940595, "rte": 64.02877697841727, "wsc": 65.38461538461539, "mrpc": 87.58620689655172, "qqp": 71.6198210773428, "mnli": 60.45232273838631} |
...
```json
{
  "o62065_minus_ordinary_inherited_wwm_seed62064": {
    "available": true,
    "delta_overall": 0.023313958299993942,
    "component_deltas": {
      "BLiMP": 0.04999999999999716,
      "Supplement": -0.010000000000005116,
      "EWoK": -0.01999999999999602,
      "Entity": -0.07000000000000028,
      "COMPS": 0.0,
      "SuperGLUE": 0.28482562469997674,
      "GlobalPIQA": 0.0,
      "Reading": -0.025000000000000355,
      "AoA": 0.0
    },
    "seed62065_overall": 42.1159198215161,
    "seed62064_overall": 42.09260586321611
  },
