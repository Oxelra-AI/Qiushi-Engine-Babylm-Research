...
## Source `learned_balanced_probe`

- input rows: 48384
- choice queries: 18432
- paired changed+unchanged records: 9216

| condition | arm | baseline/model | changed same exact | changed opposite exact | pair-both same exact | pair-both opposite exact | tie same changed |
|---|---|---|---:|---:|---:|---:|---:|
| replace_k00_spread | aligned_state_bridge | None | 0.023 | 0.984 | 0.023 | 0.964 | 0.000 |
| replace_k00_spread | heldheld_only | None | 0.029 | 0.987 | 0.029 | 0.982 | 0.000 |
| replace_k00_spread | inverted_state_bridge | None | 0.057 | 0.932 | 0.044 | 0.872 | 0.000 |
| replace_k16_spread | aligned_state_bridge | None | 0.010 | 0.990 | 0.010 | 0.987 | 0.000 |
| replace_k16_spread | heldheld_only | None | 0.029 | 0.987 | 0.029 | 0.982 | 0.000 |
| replace_k16_spread | inverted_state_bridge | None | 0.010 | 0.977 | 0.010 | 0.974 | 0.000 |
