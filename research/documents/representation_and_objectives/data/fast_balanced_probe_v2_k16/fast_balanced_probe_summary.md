...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| replace_k16_spread | aligned_state_bridge | 1.000 | 0.010 | 0.990 | 0.010 | 0.987 | 0.049 | 0.945 | 0.663 |
| replace_k16_spread | inverted_state_bridge | 1.000 | 0.010 | 0.977 | 0.010 | 0.974 | 0.016 | 0.878 | 0.678 |
| replace_k16_spread | heldheld_only | 1.000 | 0.029 | 0.987 | 0.029 | 0.982 | 0.016 | 0.953 | 0.501 |
...
## Files
- all_results: `experiments/archive/representation_and_objectives/data/fast_balanced_probe_v2_k16/all_results.json`
- aggregate_summary: `experiments/archive/representation_and_objectives/data/fast_balanced_probe_v2_k16/aggregate_summary.json`
- per-row eval predictions: `experiments/archive/representation_and_objectives/data/fast_balanced_probe_v2_k16/per_row_eval_predictions.jsonl`
- per-row train predictions: `experiments/archive/representation_and_objectives/data/fast_balanced_probe_v2_k16/per_row_train_predictions.jsonl`
