...
### shared_trunk seeds=[29000]
- graph_same_plus: mean=1.000 sd=0.000 values=[1.0]
- graph_same_minus: mean=0.000 sd=0.000 values=[0.0]
- pair_both_plus: mean=1.000 sd=0.000 values=[1.0]
- pair_both_minus: mean=0.000 sd=0.000 values=[0.0]
- mixed_acc_plus: mean=1.000 sd=0.000 values=[1.0]
- mixed_acc_minus: mean=0.000 sd=0.000 values=[0.0]
- hh_closure_plus: mean=1.000 sd=0.000 values=[1.0]
- hh_closure_minus: mean=1.000 sd=0.000 values=[1.0]
- graph_changed_opposite_frac: mean=1.000 sd=0.000 values=[1.0]
- unchanged_opposite_frac: mean=0.000 sd=0.000 values=[0.0]
- mixed_held_seen_orientation_product_same_frac: mean=0.000 sd=0.000 values=[0.0]
- heldheld_unseen_edge_closure_product_same_frac: mean=1.000 sd=0.000 values=[1.0]
...
### untied seeds=[29000]
- graph_same_plus: mean=0.750 sd=0.000 values=[0.75]
- graph_same_minus: mean=0.500 sd=0.000 values=[0.5]
- pair_both_plus: mean=0.750 sd=0.000 values=[0.75]
- pair_both_minus: mean=0.500 sd=0.000 values=[0.5]
- mixed_acc_plus: mean=0.500 sd=0.000 values=[0.5]
- mixed_acc_minus: mean=0.500 sd=0.000 values=[0.5]
- hh_closure_plus: mean=1.000 sd=0.000 values=[1.0]
- hh_closure_minus: mean=1.000 sd=0.000 values=[1.0]
- graph_changed_opposite_frac: mean=0.250 sd=0.000 values=[0.25]
- unchanged_opposite_frac: mean=0.000 sd=0.000 values=[0.0]
- mixed_held_seen_orientation_product_same_frac: mean=1.000 sd=0.000 values=[1.0]
- heldheld_unseen_edge_closure_product_same_frac: mean=1.000 sd=0.000 values=[1.0]
