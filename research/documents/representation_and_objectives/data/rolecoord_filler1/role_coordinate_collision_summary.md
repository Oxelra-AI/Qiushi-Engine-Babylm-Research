...
Best train acc: 0.506

Train fit by kind: `{"base_stable|ctx=filler|q=direct_tag": 0.5078125, "sparse_changed_focal|ctx=filler|q=direct_tag": 0.5, "sparse_stable_focal|ctx=filler|q=direct_tag": 0.5}`

| eval_set | con_acc | focal_before | focal_after | secondary_before | secondary_after | focal_after_margin | secondary_after_margin |
|---|---:|---:|---:|---:|---:|---:|---:|
| filler_direct_heldChanged_heldStable_direct_tag_heldHyp | 0.250 | 1.000 | 0.000 | 0.000 | 0.000 | -0.00 | -0.00 |
