...
Train fit by kind: `{"base_stable|ctx=filler|q=direct_tag": 0.499609375, "sparse_changed_focal|ctx=filler|q=direct_tag": 0.50390625, "sparse_stable_focal|ctx=filler|q=direct_tag": 0.5}`

| eval_set | con_acc | focal_before | focal_after | secondary_before | secondary_after | focal_after_margin | secondary_after_margin |
|---|---:|---:|---:|---:|---:|---:|---:|
| filler_direct_heldChanged_heldStable_direct_tag_heldHyp | 0.750 | 1.000 | 0.000 | 1.000 | 1.000 | -0.00 | 0.00 |
