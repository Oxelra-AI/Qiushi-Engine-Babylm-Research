...
Best train acc: 0.977

Train fit by kind: `{"base_stable_anchor|ctx=labeldup|q=direct_tag": 1.0, "base_stable_train|ctx=labeldup|q=direct_tag": 1.0, "sparse_changed_focal|ctx=labeldup|q=direct_tag": 0.5, "sparse_stable_focal|ctx=labeldup|q=direct_tag": 1.0}`

| eval_set | con_acc | focal_before | focal_after | secondary_before | secondary_after | focal_after_margin | secondary_after_margin |
|---|---:|---:|---:|---:|---:|---:|---:|
| labeldup_direct_heldChanged_heldStable_direct_tag_heldHyp | 0.750 | 0.250 | 0.750 | 1.000 | 1.000 | 1.21 | 7.75 |
