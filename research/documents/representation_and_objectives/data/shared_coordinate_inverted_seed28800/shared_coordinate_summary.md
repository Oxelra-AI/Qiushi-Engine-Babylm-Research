...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| tied | inverted_state_bridge | 28800 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 13.769 | -13.769 | 1.000 |
| untied | inverted_state_bridge | 28800 | 1.000 | 1.000 | 1.000 | 0.500 | 0.500 | 1.000 | 1.000 | 7.716 | -7.716 | 1.000 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| tied|inverted_state_bridge | 1 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 13.769 | 1.000 |
| untied|inverted_state_bridge | 1 | 1.000 | 1.000 | 1.000 | 0.500 | 0.500 | 1.000 | 1.000 | 7.716 | 1.000 |

## Tied minus untied paired differences

| comparison | n | mean | values |
|---|---:|---:|---|
| tied_minus_untied|inverted_state_bridge|arm_mixed_acc | 1 | 0.0 | [0.0] |
| tied_minus_untied|inverted_state_bridge|arm_mixed_margin | 1 | 6.052688655436777 | [6.052688655436777] |
...
| tied_minus_untied|inverted_state_bridge|true_mixed_margin | 1 | -6.052688655436777 | [-6.052688655436777] |
...
## Files
- summary JSON: `experiments/archive/representation_and_objectives/data/shared_coordinate_inverted_seed28800/shared_coordinate_summary.json`
- per-run directories: `experiments/archive/representation_and_objectives/data/shared_coordinate_inverted_seed28800`
