...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| tied | aligned_state_bridge | 28800 | 0.958 | 0.542 | 0.250 | 0.500 | 0.500 | 1.000 | 0.359 | 0.000 | 0.000 | 0.453 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| tied|aligned_state_bridge | 1 | 0.958 | 0.542 | 0.250 | 0.500 | 0.500 | 1.000 | 0.359 | 0.000 | 0.453 |
...
## Files
- summary JSON: `experiments/archive/representation_and_objectives/data/shared_coordinate_smoke/shared_coordinate_summary.json`
- per-run directories: `experiments/archive/representation_and_objectives/data/shared_coordinate_smoke`
