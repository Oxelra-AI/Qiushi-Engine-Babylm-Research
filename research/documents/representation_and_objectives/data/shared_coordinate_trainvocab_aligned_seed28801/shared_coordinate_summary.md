...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| tied | aligned_state_bridge | 28801 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 13.809 | 13.809 | 1.000 |
| untied | aligned_state_bridge | 28801 | 1.000 | 1.000 | 1.000 | 0.250 | 0.250 | 1.000 | 0.500 | 4.698 | 4.698 | 1.000 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| tied|aligned_state_bridge | 1 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 13.809 | 1.000 |
| untied|aligned_state_bridge | 1 | 1.000 | 1.000 | 1.000 | 0.250 | 0.250 | 1.000 | 0.500 | 4.698 | 1.000 |

## Tied minus untied paired differences

| comparison | n | mean | values |
|---|---:|---:|---|
| tied_minus_untied|aligned_state_bridge|arm_mixed_acc | 1 | 0.5 | [0.5] |
| tied_minus_untied|aligned_state_bridge|arm_mixed_margin | 1 | 9.111076490461613 | [9.111076490461613] |
| tied_minus_untied|aligned_state_bridge|arm_pair_both_same_graph | 1 | 0.75 | [0.75] |
| tied_minus_untied|aligned_state_bridge|arm_psc_same_graph | 1 | 0.75 | [0.75] |
| tied_minus_untied|aligned_state_bridge|hh_closure_acc | 1 | 0.0 | [0.0] |
| tied_minus_untied|aligned_state_bridge|true_mixed_margin | 1 | 9.111076490461613 | [9.111076490461613] |
...
## Files
- summary JSON: `experiments/archive/representation_and_objectives/data/shared_coordinate_trainvocab_aligned_seed28801/shared_coordinate_summary.json`
- per-run directories: `experiments/archive/representation_and_objectives/data/shared_coordinate_trainvocab_aligned_seed28801`
