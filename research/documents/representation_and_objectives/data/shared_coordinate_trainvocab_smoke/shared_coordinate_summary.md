...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| tied | aligned_state_bridge | 28890 | 0.972 | 0.500 | 0.500 | 0.500 | 0.500 | 1.000 | 0.500 | 0.000 | 0.000 | 0.406 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| tied|aligned_state_bridge | 1 | 0.972 | 0.500 | 0.500 | 0.500 | 0.500 | 1.000 | 0.500 | 0.000 | 0.406 |
...
## Files
- summary JSON: `experiments/archive/representation_and_objectives/data/shared_coordinate_trainvocab_smoke/shared_coordinate_summary.json`
- per-run directories: `experiments/archive/representation_and_objectives/data/shared_coordinate_trainvocab_smoke`
