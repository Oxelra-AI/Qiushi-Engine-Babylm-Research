# equivariant symmetry repair and macro context slot-orbit assignment-set analysis (with_common)
...
- results_json: `experiments/archive/representation_and_objectives/data/slot_orbit_solver/slot_orbit_assignment_analysis_with_common.json`
