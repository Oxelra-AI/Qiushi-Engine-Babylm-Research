# equivariant symmetry repair and macro context slot-orbit solver (no_common)
...
- results_json: `experiments/archive/representation_and_objectives/data/slot_orbit_solver/slot_orbit_solver_no_common.json`
