# equivariant symmetry repair and macro context transparent surface baselines (with_common)
...
|---|---|---|---:|---:|---:|---:|
| exposure_only | order_only | state_query | 0.625 | 0.500 | 0.500 | 0.500 |
| exposure_only | order_reltype | state_query | 0.625 | 0.500 | 0.500 | 0.500 |
| exposure_only | order_relid | state_query | 0.750 | 0.500 | 0.500 | 0.500 |
| heldheld_only | order_only | state_query | 0.625 | 0.500 | 0.500 | 0.500 |
| heldheld_only | order_reltype | state_query | 0.625 | 0.500 | 0.500 | 0.500 |
| heldheld_only | order_relid | state_query | 0.750 | 0.500 | 0.500 | 0.500 |
| aligned_state_bridge | order_only | state_query | 0.611 | 0.500 | 0.500 | 0.500 |
| aligned_state_bridge | order_reltype | state_query | 0.611 | 0.500 | 0.500 | 0.500 |
| aligned_state_bridge | order_relid | state_query | 0.750 | 0.750 | 0.500 | 0.750 |
| inverted_state_bridge | order_only | state_query | 0.611 | 0.500 | 0.500 | 0.500 |
| inverted_state_bridge | order_reltype | state_query | 0.611 | 0.500 | 0.500 | 0.500 |
...
| mixed_event_bridge | order_only | state_query | 0.625 | 0.500 | 0.500 | 0.500 |
| mixed_event_bridge | order_reltype | state_query | 0.625 | 0.500 | 0.500 | 0.500 |
| mixed_event_bridge | order_relid | state_query | 0.750 | 0.500 | 0.500 | 0.500 |
...
- results_json: `experiments/archive/representation_and_objectives/data/surface_baselines/surface_baselines_with_common.json`
